  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li ><a href="../admin/userManager.do"><i class="fa fa-circle-o text-aqua"></i> 会员</a></li>
                <li class="active"><a href="../admin/adminManager.do"><i class="fa fa-circle-o text-aqua"></i> 管理员</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li>
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="../backDesign/index.html"><i class="fa fa-circle-o text-aqua"></i> 首页推荐</a></li>
                <li><a href="../backDesign/index2.html"><i class="fa fa-circle-o text-aqua"></i> 个性化推荐</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <div class="content-wrapper">
		...
		<jsp:include page="/WEB-INF/jsp/back/adminTable.jsp"></jsp:include>
        </section>
      </div>
