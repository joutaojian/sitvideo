                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="../backDesign/dist/img/user1-128x128.jpg" alt="user image">
                        <span class='username'>
                    ...
                    <div class="post clearfix">
                      <div class='user-block'>
                        <img class='img-circle img-bordered-sm' src='../backDesign/dist/img/user7-128x128.jpg' alt='user image'>
                        <span class='username'>
                          <a href="#">Sarah Ross</a>
                          <a href='#' class='pull-right btn-box-tool'><i class='fa fa-times'></i></a>
                        </span>
                    ...
                    <div class="post">
                      <div class='user-block'>
                        <img class='img-circle img-bordered-sm' src='../backDesign/dist/img/user6-128x128.jpg' alt='user image'>
                        <span class='username'>
                          <a href="#">Adam Jones</a>
                          <a href='#' class='pull-right btn-box-tool'><i class='fa fa-times'></i></a>
                        </span>
                      ...
                      <div class='row margin-bottom'>
                        <div class='col-sm-6'>
                          <img class='img-responsive' src='../backDesign/dist/img/photo1.png' alt='Photo'>
                        </div><!-- /.col -->
                        <div class='col-sm-6'>
                          <div class='row'>
                            <div class='col-sm-6'>
                              <img class='img-responsive' src='../backDesign/dist/img/photo2.png' alt='Photo'>
                              <br>
                              <img class='img-responsive' src='../backDesign/dist/img/photo3.jpg' alt='Photo'>
                            </div><!-- /.col -->
                            <div class='col-sm-6'>
                              <img class='img-responsive' src='../backDesign/dist/img/photo4.jpg' alt='Photo'>
                              <br>
                              <img class='img-responsive' src='../backDesign/dist/img/photo1.png' alt='Photo'>
                            </div><!-- /.col -->
                          </div><!-- /.row -->
